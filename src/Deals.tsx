    ...
    <div className='h-big w-8/12 gap-3 grid grid-cols-10 grid-rows-6'>
      <div className='row-start-1 row-end-5 col-span-6 bg-deals bg-fit bg-cover bg-right'>
        <div className='flex flex-col h-full justify-between p-4'>
          ...
          <p className='text-5xl text-white font-medium w-2/3 text-shadow'>
            Pay the price for the meal
          </p>
          <p className='text-xl tracking-widester text-white text-shadow'>
            including
          </p>
          <div>
            <div className='flex drop-shadow-lg'>
              ...
              <p className='flex justify-center items-center bg-red text-white px-4 text-2xl italic'>
                <span className='text-shadow'>New</span>&nbsp;Stewed
              </p>
              <div>
          ...
          <div className='grid grid-col-5 grid-row-1 w-1/4'>
            <span className='custom-outline text-white text-5xl col-start-1 row-start-1'>
              $
            </span>
            <span
              className='custom-outline-shadow text-white text-5xl col-start-1 row-start-1'
              aria-hidden='true'>
              $
            </span>

            <span className='custom-outline text-white text-6xl col-start-2 col-end-3 row-start-1'>
              10
            </span>
            <span
              className='custom-outline-shadow text-white text-6xl col-start-2 col-end-3 row-start-1'
              aria-hidden='true'>
              10
            </span>

            <span className='custom-outline text-white text-5xl col-start-3 col-end-5 row-start-1'>
              99
            </span>
            <span
              className='custom-outline-shadow text-white text-5xl col-start-3 col-end-5 row-start-1'
              aria-hidden='true'>
              99
            </span>
          </div>
