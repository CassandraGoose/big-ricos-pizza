...
function ComboDeal() {
  return (
    <div className='col-start-7 row-start-3 row-end-5 col-end-11 flex flex-col justify-between bg-combo-deal bg-cover bg-bottom p-2'>
      ...
      <p className='text-xl text-white text-shadow'>
        Buy one fistful of <span className=' italic'>stewed tomatoes</span>, get
        one free!
      </p>
      <div className='flex justify-end items-end h-24'>
        <div className='grid grid-col-5 grid-row-1 w-1/2'>
          ...
          <span className='custom-outline text-white text-4xl col-start-3 col-end-5 row-start-1 font-bold'>
            99
          </span>
          <span
            className='custom-outline-shadow text-white text-4xl col-start-3 col-end-5 row-start-1 font-bold'
            aria-hidden='true'>
            99
          </span>
        </div>
